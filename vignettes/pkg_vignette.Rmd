---
title: "Generalized Mixed Models in GWAS using SAIGEgds"
...
```{r echo=FALSE}
unlink("grm_geno.gds", force=TRUE)
```
...
2. Zheng X, Davis J.Wade, SAIGEgds -- an efficient statistical tool for large-scale PheWAS with mixed models; (Abstract 1920276). Presented at the 69th Annual Meeting of The American Society of Human Genetics (ASHG), Oct 15-19, Houston, US.
